...
- **Browser MCP fallback** — WebFetch가 403/Cloudflare로 막힌 소스(namu.wiki,
  chosun.com 등)는 Playwright MCP 헤드리스 Chromium으로 자동 우회 fetch.
  자세한 규칙은 `celebrity-harvester.md`의 "Browser fallback for bot-protected
  pages" 섹션.
