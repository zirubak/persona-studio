...
# /simulate-meeting-team-ralph

Split-panes 회의 위에 **Ralph loop + 사용자 만족 점수 gating** 을 얹은 변형. 기존 `/simulate-meeting-team` 의 기능 전부 + 시작 전 TUI 목표 설정 + 결과 스코어링 + 미달 시 재실행.

## Step 0 — Pre-flight + TUI 만족 점수 설정

1. `/simulate-meeting-team` Step 0과 동일한 tmux/teammate-mode 사전 체크 먼저 수행.
...
## Step 1-3 — `/simulate-meeting-team` 흐름과 동일
