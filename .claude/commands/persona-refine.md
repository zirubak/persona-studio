---
description: Update specific sections of an existing persona based on user feedback. Usage: /persona-refine <name>
---
...
Re-render `.claude/agents/persona-<name>.md` from the updated
`personas/<name>.md` (same template as `/create-persona` Step 5).
